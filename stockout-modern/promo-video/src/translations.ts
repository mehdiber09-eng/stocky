...
const fr: Strings = {
  ...
  cta_title_a: 'Stocky',
  cta_title_b: '5 prédictions IA offertes',
  cta_pricing: '14€ · 15$ / mois',
  cta_button: 'Commence gratuitement',
  cta_url: 'stocky.app',
...
const ar: Strings = {
  ...
  cta_title_a: 'Stocky',
  cta_title_b: '٥ توقّعات ذكاء اصطناعي مجّاناً',
  cta_pricing: '١٤€ · ١٥$ / شهر',
  cta_button: 'ابدأ مجّاناً',
  cta_url: 'stocky.app',
...
const en: Strings = {
  ...
  cta_title_a: 'Stocky',
  cta_title_b: '5 free AI predictions',
  cta_pricing: '€14 · $15 / month',
