...
import {
  ...
  CreditCard, Truck, X, QrCode, FlaskConical, PackageCheck, Printer,
} from 'lucide-react'
...
type NavKey =
  ...
  | 'nav_pricing' | 'nav_profile' | 'nav_reception' | 'nav_qr_print'
...
const NAV_ITEMS: { to: string; key: NavKey; icon: LucideIcon }[] = [
  ...
  { to: '/qr-print',        key: 'nav_qr_print',   icon: Printer },
